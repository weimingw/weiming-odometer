...
export default function Odometer(props) {
    ...
    return <div className="exposed-odometer">{renderNumbers()}</div>;
}
...
function RollingNumber(props) {
    ...
    */
    ...
    return (
        <div className="exposed-rolling-number-window">
            <div className="exposed-rolling-number-placeholder"></div>
            <div
                className="exposed-rolling-number"
                style={{
